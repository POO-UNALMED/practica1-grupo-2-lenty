...
public class Main {
	...
	public static void menuOrden() {
		...
		case "1":
			...
			id=in.nextInt();
			System.out.println("El cliente de la orden: ");
			...
			es=in.next();
			new Orden(id,null,null,null,valor,cantP,peso,es);
			break;
		
		case "2":
			Orden i=new Orden(1, null, null, null, 10, 2, 15, "Aceptada");
			//ESCOGER LA ORDEN A MODIFICAR
			i.modificarOrden();
			break;
		
		case "3":
			Orden j=new Orden(1, null, null, null, 10, 2, 15, "Aceptada");
			//ESCOGER LA ORDEN
			j.cancelarOrden(j);
			break;
